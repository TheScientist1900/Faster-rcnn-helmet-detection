...
if __name__ == "__main__":
    ...
    video_save_path = "badminton_result.mp4"
    video_fps       = 10.0
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        dir_save_path   = r"your-path\faster-rcnn-pytorch-master\VOCdevkit\VOC2028\Predict"
        test_annot = open(r'your-path\faster-rcnn-pytorch-master\VOCdevkit\VOC2028\test.txt', 'r',encoding='UTF-8')
        test_lines = test_annot.readlines()
