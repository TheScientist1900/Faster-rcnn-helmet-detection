...
def fit_one_epoch(model, train_util, loss_history, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, Epoch, cuda, logger):
    total_loss = 0
    rpn_loc_loss = 0
    rpn_cls_loss = 0
    roi_loc_loss = 0
    ...
    logger.info('Epoch: {}\nTrain loss: {}  | Val loss: {}'.format(epoch+1, total_loss / epoch_step, val_loss / epoch_step_val))
